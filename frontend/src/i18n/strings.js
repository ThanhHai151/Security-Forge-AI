...
export const STRINGS = {
  en: {
    ...
    supReasoningHeading: "Questions to resolve",
    supReasoningCondition: "Continue if",
    supRoeHeading: "Rules of engagement",
    supVendor: "Agent harness",
    supVendorGeneric: "Vendor neutral",
    supCriticality: "Asset criticality",
    supCriticalityUnknown: "Unknown (treat as production)",
    supCriticalityCritical: "Critical",
    supCriticalityProduction: "Production",
    supCriticalityNonProduction: "Non-production",
    supAuthorizationRef: "Authorization reference",
    supAuthorizationRefPlaceholder: "Signed SOW / ticket / approval ID",
    supWindowStart: "Testing window starts",
    supWindowEnd: "Testing window ends",
    supExcludedTargets: "Excluded targets",
    supExcludedTargetsPlaceholder: "comma-separated hosts or CIDRs",
    supAllowSubdomains: "Include subdomains in scope",
    supAuthorizationConfirm: "I confirm written authorization for this target and window.",
    supHarnessReady: "Harness ready",
    supHarnessDraft: "Harness blocked",
    supCopyHarness: "Copy harness",
    supHarnessCopied: "Copied",
  ...
  vi: {
    ...
    supReasoningHeading: "Câu hỏi cần trả lời",
    supReasoningCondition: "Tiếp tục nếu",
    supRoeHeading: "Quy tắc kiểm thử",
    supVendor: "Harness tác nhân",
    supVendorGeneric: "Không phụ thuộc nhà cung cấp",
    supCriticality: "Mức độ quan trọng của tài sản",
    supCriticalityUnknown: "Chưa rõ (xử lý như production)",
    supCriticalityCritical: "Tối quan trọng",
    supCriticalityProduction: "Production",
    supCriticalityNonProduction: "Không phải production",
    supAuthorizationRef: "Tham chiếu ủy quyền",
    supAuthorizationRefPlaceholder: "SOW / ticket / mã phê duyệt đã ký",
    supWindowStart: "Bắt đầu khung giờ kiểm thử",
    supWindowEnd: "Kết thúc khung giờ kiểm thử",
    supExcludedTargets: "Mục tiêu loại trừ",
    supExcludedTargetsPlaceholder: "host hoặc CIDR, ngăn cách bằng dấu phẩy",
    supAllowSubdomains: "Bao gồm subdomain trong phạm vi",
    supAuthorizationConfirm: "Tôi xác nhận có ủy quyền bằng văn bản cho mục tiêu và khung giờ này.",
    supHarnessReady: "Harness sẵn sàng",
    supHarnessDraft: "Harness đang bị chặn",
    supCopyHarness: "Sao chép harness",
    supHarnessCopied: "Đã sao chép",
    supTerminalHeading: "Terminal",
